...
Route::group($routeGroup, function(){
  ...
  Route::get('surveys/reports', 'Sirs\Surveys\Controllers\ReportController@index');
  ...
  Route::resource('surveys/data-dictionary', 'Sirs\Surveys\Controllers\DictionaryController', ['only'=>['index','show']]);
});
